...
def load_image(image_path: str) -> Image.Image:
    ...
    if os.path.isfile(image_path):
        ...
        raise ValueError("Invalid image path. Provide a valid file path or URL.")
...
def main(image_path: str, text: str):
    """
    Main function to load an image and compute similarity with text.
    ...
    try:
        ...
        print(f"Similarity score between the image and the text '{text}': {similarity_score:.4f}")
