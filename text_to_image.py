...
def main():
    ...
    parser.add_argument("--model", type=str, default="CompVis/stable-diffusion-v1-4", help="The model to use for generation.")
    parser.add_argument("--output", type=str, default="output.png", help="The output path for the generated image.")

    args = parser.parse_args()

    # Generate the image based on the provided prompt
    generate_image(args.prompt, model_name=args.model, output_path=args.output)
