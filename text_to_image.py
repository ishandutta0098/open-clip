...
def main():
    ...
    parser.add_argument("--model_id", type=str, default="CompVis/stable-diffusion-v1-4", help="The model ID for the Stable Diffusion model.")
    ...
    generate_image(args.prompt, args.model_id, args.output)
