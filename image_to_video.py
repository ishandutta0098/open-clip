...
def main(input_folder, output_video_path):
    ...
    # Optionally process images with diffusers
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_video_path", type=str, help="Path where the video will be saved.")
    args = parser.parse_args()

    main(args.input_folder, args.output_video_path)